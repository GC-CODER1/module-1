...
const mockMissions = [
  ...
  },
  {
    ...
    deliveryLocation: 'Karol Bagh Area',
    pickupTime: '1:00 PM',
    deliveryTime: '2:30 PM',
    pickupContact: 'Dr. Kumar',
    deliveryContact: 'Raj Patel',
    type: 'medical',
    priority: 'high',
  },
];
...
export default function FacilitatorDashboard() {
  ...
  const MissionCard = ({ mission }) => {
    ...
    const handlePress = () => {
      ...
      router.push(`/mission-detail?id=${mission.id}`);
    };
    ...
    return (
      <Animated.View style={cardAnimatedStyle}>
        <TouchableOpacity style={styles.missionCard} onPress={handlePress}>
